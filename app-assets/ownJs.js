...
function infoCard(mode, message, ...params){
	...
	let ICC= document.getElementById("ICC");
		...
		{
			var slider = "<form id=\"form-id\" action=\"rozchodniaczki/zmien_klub.php\" method=\"POST\"><fieldset class=\"form-group\"><select class=\"custom-select\" id=\"custom_select\" name=\"id_klubu\" required>";
