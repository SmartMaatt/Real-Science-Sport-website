	...
	<div class="col-12">
	  <div class="card">
		<div class="card-header">
		  <h2 class="card-title" id="basic-layout-tooltip">Wzrostomierz</h2>
		  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
		   <div class="card-text">
				<p>Załącz arkusz excel w celu dodania badań "Wzrostomierz"</p>
			</div>
		</div>
		  ...
		  <div class="card-body pt-0">
			...
			<div class="px-2">
				...
				<form action="rozchodniaczki/upload_excel.php" method="POST" class="dropzone" id="dropzoneFrom" enctype="multipart/form-data">
					<input type="hidden" name='badanie' value="wzrostomierz" />
				</form>
