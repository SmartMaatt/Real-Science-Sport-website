<?php
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h2 class="card-title">Historia wzrostu</h2>
						<div class="card-text">
							<p>Poniżej znajdziesz historię zmiany twojego wzrostu na podstawie wprowadzonych rekordów oraz inne przydatne informacje</p>
						</div>
					</div>
	...
	echo '<div class="col-lg-6 col-12">
				<div class="card">
					<div class="card-header">
						<h2 class="card-title">Aktualizuj wzrost</h2>
					</div>
					<div class="card-body" style="padding-top:0;">';
					
	echo '<form id="wzrost_form" class="form" method="post" action="rozchodniaczki/zmien_wzrost.php">
			<div class="form-body">
