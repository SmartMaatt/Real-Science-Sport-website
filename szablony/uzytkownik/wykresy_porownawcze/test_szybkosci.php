<?php
	...
	{	
		...
		$sql = "SELECT (pomiar1_1 + pomiar2_1 + pomiar3_1)/3 AS pomiar1, (pomiar1_2 + pomiar2_2 + pomiar3_2)/3 AS pomiar2, (pomiar1_3 + pomiar2_3 + pomiar3_3)/3 AS pomiar3, data FROM test_szybkosci WHERE id_klienta = '$id_klienta' ORDER BY data";
