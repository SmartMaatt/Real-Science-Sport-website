...
<head>
  ...
  <title>Grafik - Wysokiej klasy kręgielnia</title>
    ...
    <div class="navbar-wrapper">
      ...
      <div class="navbar-container content">
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <h3 class="content-header-title mb-0 d-inline-block">Grafik pracowników</h3>
    ...
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
	   <li class="nav-item has-sub"><a href="#"><i class="la la-calendar"></i><span class="menu-title" data-i18n="nav.event_calendars.main">Rezerwacje</span></a>
		...
		<li class="active nav-item"><a href="grafik.php">
    ...
    <div class="content-wrapper">
      <div class="content-body">
        ...
        <section id="basic-examples">
		  ...
		  <div class="row">
            <div class="col-12">
              <div id="table_card" class="card table_card5">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
					...
					<form method="POST" action="grafik.php" id="table_date_picker">
					...
					<?php
						...
						else
						{
							$id_osoby = $_SESSION['id_osoby'];
							$cell = "<td></td>";
							$givenDate = $_SESSION['data'];
							$check_monday = strtotime($givenDate);
							
							if(date('D', $check_monday) == 'Mon') 
							{
								$previous_monday = $givenDate;
							}
							else
							{
							...
							echo "<input type='date' class='form-control' id='global_date' name='global_date' value='".$givenDate."' required/>";
							echo "</form>";
							echo '<table id="app_table" class="grafik_table">';
							echo '<tr id="tablenav">';
							echo "<td>Dzien</td>";
							for($j = 5; $j<23; $j++)
							{
							...
							echo '</tr>';
							for($i = $previous_monday; $i<$next_monday; $i++)
							{
								$sql = "SELECT * FROM grafik WHERE id_osoby = '$id_osoby' AND data = '$i'";
								if($result = @$connection->query($sql))
								{
									echo "<td>$i</td>";
									$row = $result->fetch_assoc();
									if (isset($row['godz_roz']))
									{
										for($j = 5; $j<23; $j++)
										{
											if($j < $row['godz_roz'] || $j > $row['godz_zak'])
											{
											}
											else
											{
												$cell = "<td class='table_reserved'></td>";
											}
											echo "$cell";
											$cell = "<td></td>";
										}
