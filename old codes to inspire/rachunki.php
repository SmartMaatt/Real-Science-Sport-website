...
<head>
  ...
  <title>Rachunki - Wysokiej klasy kręgielnia</title>
    ...
    <div class="navbar-wrapper">
      ...
      <div class="navbar-container content">
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <h3 class="content-header-title mb-0 d-inline-block">Rachunki</h3>
    ...
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
	   <li class="nav-item has-sub"><a href="#"><i class="la la-calendar"></i><span class="menu-title" data-i18n="nav.event_calendars.main">Rezerwacje</span></a>
		...
		<li class="active nav-item"><a href="rachunki.php">
      ...
      <div class="content-body">
		...
		<!-- OKNO FORMULARZA -->
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="horz-layout-icons">Wyszukaj klienta</h4>
                ...
                <div class="card-content collpase collapse show" style="">
				  ...
				  <!-- TUTAJ JEST FORMULARZ DO ZMIANY!!! -->
         ...
         <!-- ////////////////////////////////////////////////////////////////////////////-->
		  ...
		  <div class="row">
            <div class="col-12">
              <div id="table_card" class="card table_card4">
                <div class="card-naglowek_cor card-header">
                  <h4 class="card-title"> Rozliczenia klienta
				  </h4>
                  <div class="heading-elements">
                      <a data-action="collapse"><i class="ft-minus"></i></a>
                  </div>
                  ...
                  <div class="card-body">
					...
					<?php
						...
						else
						{
							...
							echo "</form>";
							echo "<h1 id='No_data_msg'>Brak danych, wybierz klienta!</h1>";
							echo "<h3>Klient: Mateusz Płonka</h3>";
							echo '<table id="app_table" class="cash_table">';
							...
							echo '<tr>';
							echo '<td><p>Mega zestaw</p></td>';
							echo '<td><p>120zł</p></td>';
							echo '</tr>';
