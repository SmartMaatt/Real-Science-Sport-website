      ...
      <div class="content-body">
		...
		<!-- OKNO FORMULARZA -->
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="horz-layout-icons">Dodaj zamówienie</h4>
                ...
                <div class="card-content collpase collapse" style="">
                  <div class="card-body">
				  <center><h1><b>To nie są droidy których szukacie</b></h1><img width="50%" src="app-assets/images/roboty.jpg"/></center>
                  </div>
                </div>
              </div>
            </div>
         ...
         <!-- ////////////////////////////////////////////////////////////////////////////-->
		  ...
		  <div class="row">
            <div class="col-12">
              <div id="table_card" class="card table_card6">
                <div class="card-naglowek_cor card-header">
                  <h4 class="card-title"> Spis zamówień
				  </h4>
                  <div class="heading-elements">
                  ...
                  <div class="card-body">
					...
					<?php
						...
						else
						{
							...
							echo "</form>";
							echo '<table id="app_table" class="cash_table order_table">';
							...
							if($result = @$connection->query($sql))
							{
								for($i = 0; $i<$result->num_rows; $i++)
								{
									$row = $result->fetch_assoc();
									$id_k = $row['id_klienta'];
									$sql2 = "SELECT imie, nazwisko FROM klient WHERE id_klienta = '$id_k'";
									if($result2 = @$connection->query($sql2))
									{
										$row2 = $result2->fetch_assoc();
										$imie = $row2['imie']; 
										$nazwisko = $row2['nazwisko']; 
										$id_z = $row['id_zamowienia'];
										$cena = $row['cena'];
										
										echo '<tr>';
										echo "<td><p>$id_z</p></td>";
										echo "<td><p>$imie $nazwisko</p></td>";
										echo "<td><p>$cena</p></td>";
										echo '<td>
										<form action="szczegoly_gastro.php" method="post">
											<input type="submit" class="btn btn-dark" value="Wyświetl szczegóły" name='.$id_z;'/>
											</form>
										</td>';
										echo '</tr>';
									}
